...
urlpatterns = [
    ...
    #path('Molecular/AMLOdds/', HaemOncologyFunctionality.AMLOddsSearch.as_view(), name="HaemOncAMLOddsSearch"),
    ...
    path('Molecular/WGS/', HaemOncologyFunctionality.WGSSearch.as_view(), name="WGSSearch"),
    #path('Molecular/MDS/', HaemOncologyFunctionality.MDSSearch.as_view(), name="HaemOncMDSSearch"),
    ...
    #path('Molecular/D-HCL/', HaemOncologyFunctionality.DHCLSearch.as_view(), name="HaemOncDHCLSearch"),
    #path('Molecular/D-ONC/', HaemOncologyFunctionality.DONCSearch.as_view(), name="HaemOncDONCSearch"),
    #path('Molecular/D-CS/', HaemOncologyFunctionality.DCSSearch.as_view(), name="HaemOncDCSSearch"),
    ...
    path('Molecular/Allocate/<str:_labNumber>/<str:_workflowName>/', HaemOncologyFunctionality.SetAllocatedToForDNA.as_view(), name="DNASetAllocatedTo"),
    path('Sample/<str:_labNumber>/<str:_workflowName>/', SampleFunctionality.SampleForm.as_view(), name="SampleForm"),
    path('Molecular/Allocate/<str:_labNumber>/<str:_workflowName>/AllocateComplete/', TemplateView.as_view(template_name='AllocateComplete.html'), name="AllocateComplete"),
]